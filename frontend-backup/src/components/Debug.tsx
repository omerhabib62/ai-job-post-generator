...
export const Debug: React.FC = () => {
  useEffect(() => {
    ...
    try {
      ...
      import('@/components/layout/MainLayout').catch(e => console.error('MainLayout import error:', e));
      import('@/contexts/AuthContext').catch(e => console.error('AuthContext import error:', e));
    } catch (e) {
